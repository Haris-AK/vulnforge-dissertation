...
\documentclass[serif,oneside,single,parskip,raggedright,numeric]{qproposal}
...
\keywords{generative AI, cybersecurity education, CTF, vulnerability generation, LLM, sandboxed environments}
